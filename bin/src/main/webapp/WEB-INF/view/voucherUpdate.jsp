            ...
            <div class="wrapper">
                ...
                <div class="main p-3">
                    <div class="text-center">
                        <form class="py-3" action="voucherUpdate" method="post">
                            <h1 class="my-3">Chỉnh sửa Voucher</h1>
                            <input type="hidden" class="form-control" placeholder="Tên Voucher"
                                    aria-label="productType" aria-describedby="basic-addon1" name="voucherId" value="${voucherEdit.voucherId}">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Tên Voucher"
                                    aria-label="productType" aria-describedby="basic-addon1" name="name" value="${voucherEdit.name}">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-bag"></i></span>
                                <input type="text" class="form-control" placeholder="Giảm Giá" aria-label="productType"
                                    aria-describedby="basic-addon1" name="discount" value="${voucherEdit.discount}">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-bag"></i></span>
                                <input type="text" class="form-control" placeholder="Phần Trăm" aria-label="productType"
                                    aria-describedby="basic-addon1" name="percentage" value="${voucherEdit.percentage}">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-bag"></i></span>
                                <input type="date" class="form-control" placeholder="Ngày Tạo" aria-label="productType"
                                    aria-describedby="basic-addon1" name="createDate" 
                                    <fmt:formatDate value="${voucherEdit.createDate}" pattern="yyyy-MM-dd" var="formattedDate" />
                                    value="${formattedDate}">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-bag"></i></span>
                                <input type="date" class="form-control" placeholder="Ngày Hết Hạn"
                                    ...
                                    <fmt:formatDate value="${voucherEdit.expiresAt}" pattern="yyyy-MM-dd" var="formattedDate" />
                                    value="${formattedDate}">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1"><i class="bi bi-bag"></i></span>
                                <input type="text" class="form-control" placeholder="Mô Tả" aria-label="productType"
                                    aria-describedby="basic-addon1" name="description" value="${voucherEdit.description}">
                            </div>
