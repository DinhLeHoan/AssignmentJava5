								...
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-10">
										...
										<p class="h3 text-danger m-0">
											<b>300.000</b> <span class="h5 text-success"><i
												class="bi bi-arrow-down-short"></i> 94%</span>
										</p>
								...
								<div class="row">
									...
									<div class="col-lg-10 col-md-10 col-10">
										...
										<p class="h3 text-primary m-0">
											<b>0</b> <span class="h5 text-success"><i
												class="bi bi-arrow-down-short"></i> 0%</span>
										</p>
										<p>Hôm qua : 0</p>
									</div>
								</div>
							...
							<div class="col-lg-8">
								<p class="h5">
									<b>DOANH SỐ HÔM NAY</b> <span class="h5 text-primary"><i
										class="bi bi-arrow-right h6 text-dark"></i> 325.000</span>
								</p>
						...
						<div class="container">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="day-tab"
										data-bs-toggle="tab" data-bs-target="#day" type="button"
										role="tab" aria-controls="day" aria-selected="true">Theo
										Ngày</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="hour-tab" data-bs-toggle="tab"
										data-bs-target="#hour" type="button" role="tab"
										aria-controls="hour" aria-selected="false">Theo Giờ</button>
								</li>
								<li class="nav-item" role="presentation">
						...
						<div class="card history-invoice">
							...
							<div class="card-body">
								<div class="card-body">
									...
									<c:forEach var="btoday" items="${billIdToday}" varStatus="loop">
										<div class="row my-3">
											<c:url var="billDetailUrl" value="/historyInvoice/${btoday}" />
											<a href="${billDetailUrl}" class="col-2"><i
												class="bi bi-basket3-fill"></i></a>
											<div class="col-10 col-lg-8">Trần Gia vừa bán đơn hàng
												với giá trị có mã là ${btoday}</div>
											<div class="col-12 col-lg-2">${loop.index + 1}phút
												trước</div>
										</div>
									</c:forEach>
								</div>
