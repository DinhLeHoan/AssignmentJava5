    ...
    <div class="wrapper">
                        ...
                        <div class="col-xl-5 col-10">
                            ...
                            <div class="row border product">
                                <c:forEach var="productCount" items="${productCounts}">
                                    <div class="col-md-4">
                                        <img src="https://imagestrangia.blob.core.windows.net/image/${productCount.image}"
        ...
        <div class="total-amount" id="footer">
            <div class="container text-center">
                <a href="/home" type="button" class="btn btn-secondary p-3 m-3"> Ghim hóa đơn </a>
                <a href="/home/${billId}">
                    <div class="btn btn-success p-3 m-3">Thanh toán ngay</div>
                </a>
                <a href="/home/delete/${billId}">
