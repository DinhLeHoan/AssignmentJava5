                                        ...
                                        <div class="square-box">
                                            ...
                                            <div class="square-content p-3">
                                                ...
                                                <div class="d-flex flex-row-reverse">
                                                    <a type="button" 
                                                        class="btn btn-sm bi bi-trash text-success border border-success rounded mx-1"></a>
                                                    <a type="button" href="/invoiceDetail"
                                                        class="btn btn-sm bi bi-bag-plus-fill text-success border border-success rounded mx-1"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
