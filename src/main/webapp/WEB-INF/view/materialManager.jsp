                            ...
                            <div class="container">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="nguyen-lieu-tab" data-bs-toggle="tab"
                                            data-bs-target="#nguyen-lieu" type="button" role="tab" aria-controls="nguyen-lieu"
                                            aria-selected="true">Danh sách nguyên
                                            liệu</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="chinh-sua-tab" data-bs-toggle="tab"
                                            data-bs-target="#chinh-sua" type="button" role="tab"
                                            aria-controls="chinh-sua" aria-selected="false">Chỉnh sửa nguyên
                                            liệu</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="them-tab" data-bs-toggle="tab"
                                            data-bs-target="#them" type="button" role="tab" aria-controls="them"
                                            aria-selected="false">Thêm nguyên liệu</button>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content my-3" id="myTabContent">
                                    <!-- Tab: Súp -->
                                    <div class="tab-pane fade show active" id="nguyen-lieu" role="tabpanel"
                                        aria-labelledby="nguyen-lieu-tab" style="height: 0px;">
                                        <div class="row">
                                            <div class="col-lg-1">
