						...
						<div class="col-md-12 col-lg-10 col-xl-8">
							<div class="container">
								<div class="row">
									...
									<form action="materialUpdate" class="col-lg-6 col-md-8"
										method="post">
										<h1 class="my-3">Chỉnh sửa nguyên liệu</h1>
										<input type="hidden" name="ingredientId"
											value="${ingredientEdit.ingredientId}">
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												...
												name="name" value="${ingredientEdit.name}">
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												class="lni lni-agenda"></i></span> <select class="form-select"
												id="country" name="unit">
												<option ${ingredientEdit.unit eq "Kg" ? 'selected' : ''} value="Kg">Kg</option>
												<option ${ingredientEdit.unit eq "Cái" ? 'selected' : ''} value="Cái">Cái</option>
												<option ${ingredientEdit.unit eq "Quả" ? 'selected' : ''} value="Quả">Quả</option>
												<option ${ingredientEdit.unit eq "Bao" ? 'selected' : ''} value="Bao">Bao</option>
												<option ${ingredientEdit.unit eq "Gói" ? 'selected' : ''} value="Gói">Gói</option>
											</select>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon5"><i
												...
												name="amount" value="${ingredientEdit.amount}">
										</div>
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon5"><i
												...
												aria-label="text" aria-describedby="basic-addon5"
												name="minAmount" value="${ingredientEdit.minAmount}">
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												...
												aria-label="productType" aria-describedby="basic-addon1"
												name="note" value="${ingredientEdit.note}">
										</div>
