									...
									<form action="productUpdate" method="post"
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												...
												value="${productEdit.name}" aria-label="productType"
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												...
												<c:forEach var="item" items="${tagList}">
													<option ${productEdit.tag.tagId eq item.tagId? 'selected':''} value="${item.tagId}">${item.name} </option>
												</c:forEach>
											</select>
										</div>
										<div class="input-group mb-3">
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" name="active"
													...
													${productEdit.active ? 'checked' : ''}> <label
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon5"><i
												...
												value="${productEdit.note}" class="form-control"
												placeholder="Ghi chú" aria-label="text"
										...
										<div class="input-group mb-3">
											<input class="form-control" id="productImage"
												accept="image/*" aria-label="Chọn ảnh sản phẩm" type="file"
