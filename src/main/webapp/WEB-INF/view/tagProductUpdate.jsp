						...
						<div class="col-md-12 col-lg-10 col-xl-8">
							<div class="container">
								...
								<div class="row">
									...
									<form action="tagProductUpdate" class="col-lg-6 col-md-8"
										method="post">
										<h1 class="my-3">Chỉnh sửa loại sản phẩm</h1>
										<input type="hidden" name="tagId" value="${tagProduct.tagId}">
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												class="lni lni-agenda"></i></span> <input type="text"
												class="form-control" placeholder="Tên sản phẩm" name="name"
												value="${tagProduct.name}" aria-label="productType"
										...
										<div class="input-group mb-3">
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" name="active"
													...
													${tagProduct.active ? 'checked' : ''}> <label
