	...
	<div class="wrapper">
		...
		<div class="main py-5">
			<div class="text-center">
				<h1 class="header-main my-5">CHỈNH SỬA NGUYÊN LIỆU</h1>
						...
						<div class="col-md-12 col-lg-10 col-xl-8">
							<div class="container my-3">
								<div class="row">
									...
									<form class="col-lg-6 col-md-8" action="materialUpdate"
										method="post">
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
												...
												<option ${ingredientEdit.unit eq "Kg" ? 'selected' : ''}
													value="Kg">Kg</option>
												<option ${ingredientEdit.unit eq "Cái" ? 'selected' : ''}
													value="Cái">Cái</option>
												<option ${ingredientEdit.unit eq "Quả" ? 'selected' : ''}
													value="Quả">Quả</option>
												<option ${ingredientEdit.unit eq "Bao" ? 'selected' : ''}
													value="Bao">Bao</option>
												<option ${ingredientEdit.unit eq "Gói" ? 'selected' : ''}
													value="Gói">Gói</option>
											</select>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon5"><i
												...
												name="amount" value="${ingredientEdit.amount}" required>
										</div>
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon5"><i
												...
												aria-label="text" aria-describedby="basic-addon5"
												name="minAmount" value="${ingredientEdit.minAmount}" required>
										</div>
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i
