                        ...
                        <div class="col-sm-12 col-md-12 col-lg-10 col-xl-8">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <form class="col-lg-6 col-md-8 col-sm-10" action="voucherUpdate" method="post">
                                        <input type="hidden" class="form-control" placeholder="Tên Voucher"
                                            aria-label="productType" aria-describedby="basic-addon1" name="voucherId"
                                            value="${voucherEdit.voucherId}">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" class="form-control" placeholder="Ngày Tạo"
                                                aria-label="productType" aria-describedby="basic-addon1"
                                                name="createDate" <fmt:formatDate value="${voucherEdit.createDate}"
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" class="form-control" placeholder="Ngày Hết Hạn"
                                                aria-label="productType" aria-describedby="basic-addon1"
                                                name="expiresAt" <fmt:formatDate value="${voucherEdit.expiresAt}"
                                                pattern="yyyy-MM-dd" var="formattedDate" />
                                            value="${formattedDate}">
                                        </div>
